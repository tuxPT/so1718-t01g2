/**
 *  \author Artur Pereira - 2005--2017
...
/* SOFS17 support filename (should be the absolute path) */
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(111, GREEN, "sofs_mount()\n");
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(112, GREEN, "sofs_unmount(\"%s\")\n", (char *)path);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(113, GREEN, "sofs_getattr(\"%s\", %p)\n", path, st);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(114, GREEN, "sofs_access(\"%s\", %x)\n", path, opRequested);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(115, GREEN, "sofs_mknod(\"%s\", %x, %x)\n", path, (uint32_t) mode,
                 (uint32_t) rdev);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(116, GREEN, "sofs_mkdir(\"%s\", %x)\n", path, (uint32_t) mode);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(117, GREEN, "sofs_unlink(\"%s\")\n", path);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(118, GREEN, "sofs_rmdir(\"%s\")\n", path);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(119, GREEN, "sofs_rename(\"%s\", \"%s\")\n", path, newPath);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(120, GREEN, "sofs_link(\"%s\", \"%s\")\n", path, newPath);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(121, GREEN, "sofs_chmod(\"%s\", 0%o)\n", path, (uint32_t) mode);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(122, GREEN, "sofs_chown(\"%s\", %" PRIu32 ", %" PRIu32 ")\n", path,
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(123, GREEN, "sofs_truncate(\"%s\", %u)\n", path, (uint32_t) length);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(124, GREEN, "sofs_utime(\"%s\", %p)\n", path, times);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(125, GREEN, "sofs_statfs(\"%s\", %p)\n", path, st);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(126, GREEN, "sofs_open(\"%s\", %p)\n", path, fi);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(127, GREEN, "sofs_read(\"%s\", %p, %" PRIu32 ", %" PRId32 ", %p)\n", path,
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(128, GREEN, "sofs_write(\"%s\", %p, %" PRIu32 ", %" PRId32 ", %p)\n", path,
                 buff, (uint32_t) count, (int32_t) pos, fi);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(129, GREEN, "sofs_flush(\"%s\", %p)\n", path, fi);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(130, GREEN, "sofs_release(\"%s\", %p)\n", path, fi);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(131, GREEN, "sofs_fsync(\"%s\", %d, %p)\n", path, isdatasync, fi);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(132, GREEN, "sofs_opendir(\"%s\", %p)\n", path, fi);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(133, GREEN, "sofs_readdir(\"%s\", %p, %p, %" PRId32 ", %p)\n", path, buf,
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(134, GREEN, "sofs_releasedir(\"%s\", %p)\n", path, fi);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(135, GREEN, "sofs_fsyncdir(\"%s\", %d, %p)\n", path, isdatasync, fi);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(136, GREEN, "sofs_symlink(\"%s\", \"%s\")\n", effPath, path);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(137, GREEN, "sofs_readlink(\"%s\", %p, %" PRIu32 ")\n", path, buf,
                 (uint32_t) size);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(138, GREEN, "sofs_setxattr(\"%s\", \"%s\", %p, %" PRIu32 ", %d)\n", path,
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(139, GREEN, "sofs_getxattr(\"%s\", \"%s\", %p, %" PRIu32 ")\n", path, name,
                 value, (uint32_t) size);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(140, GREEN, "sofs_listxattr(\"%s\", \"%s\", %" PRIu32 ")\n", path, list,
                 (uint32_t) size);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(141, GREEN, "sofs_removexattr(\"%s\", \"%s\")\n", path, name);
...
{
fprintf(stderr, "=============================================\n");
    soColorProbe(142, GREEN, "sofs_getdir(\"%s\", ...)\n", path);
 ...
 */
const struct fuse_operations sofs17_fuse_operations = {
...
int main(int argc, char *argv[])
{
    ...
    return fuse_main(fargc, fargv, &sofs17_fuse_operations, NULL);
}
