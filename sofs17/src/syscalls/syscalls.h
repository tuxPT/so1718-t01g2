 ...
 *
 *  \author Artur Carneiro Pereira 2007-2009, 2016-2017
 *  \author Miguel Oliveira e Silva 2009, 2017
 *  \author António Rui Borges - 2010--2015
 *
 */

#ifndef __SOFS17_SYSCALLS__
#define __SOFS17_SYSCALLS__
 ...
 *
 * \brief Set of system calls for group work    
 *
 * @{ 
 *
 * */
 ...
 * \brief Remaining system calls
 * @{ 
*/
/* ******************************************************************* */

/**
 *  \brief Open the sofs17 file system.
 *
...
/**
 *  \brief Close the sofs17 file system.
 *
