...
#ifndef __SOFS17_FREELISTS_BIN__
#define __SOFS17_FREELISTS_BIN__
 ...
 */
uint32_t soAllocInodeBin(uint32_t type);
 ...
 */
void soFreeInodeBin(uint32_t in);
 ...
 */
void soFreeClusterBin(uint32_t cn);
...
#endif				/* __SOFS17_FREELISTS_BIN__ */
